...
REM
REM Generated by Vivado on Wed Mar 23 23:19:07 +0800 2022
...
echo "xvlog --incr --relax -prj tb_32_vlog.prj"
call xvlog  --incr --relax -prj tb_32_vlog.prj -log xvlog.log
