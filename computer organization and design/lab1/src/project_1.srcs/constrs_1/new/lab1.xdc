...
set_input_delay -clock [get_clocks clk] -min -add_delay 10.000 [get_ports {sel[*]}]
set_input_delay -clock [get_clocks clk] -max -add_delay 10.000 [get_ports {sel[*]}]
set_input_delay -clock [get_clocks clk] -min -add_delay 10.000 [get_ports {x[*]}]
set_input_delay -clock [get_clocks clk] -max -add_delay 10.000 [get_ports {x[*]}]
set_input_delay -clock [get_clocks clk] -min -add_delay 10.000 [get_ports en]
set_input_delay -clock [get_clocks clk] -max -add_delay 10.000 [get_ports en]
set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports {y[*]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 20.000 [get_ports {y[*]}]
set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports z]
set_output_delay -clock [get_clocks clk] -max -add_delay 20.000 [get_ports z]
